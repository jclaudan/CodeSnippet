      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-start justify-center gap-20">
        <div className="md:w-1/2 max-w-lg self-center">
          <h1 className="text-4xl font-bold mb-4 text-gray-900">
            Votre bibliothèque de code vous attend
          </h1>
          <p className="text-gray-600 text-base mb-6">
            Gérez votre collection de snippets. Organisez, partagez et retrouvez
            votre code en quelques clics.
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Tous vos snippets favoris centralisés et organisés au même
                endroit
              </p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Retrouvez instantanément le code dont vous avez besoin
              </p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              <h3 className="font-semibold text-gray-900 mb-1 text-sm">
              ...
              <p className="text-gray-600 text-sm">
                Gagnez du temps en réutilisant vos meilleurs morceaux de code
              </p>
            </div>
          </div>
        </div>
